<template>
    <div id="appContainer" class="w-full min-h-[100vh] dark:text-[#FEFCE4] relative flex flex-col">
        <!-- 页眉 -->
        ...
        <router-view />
        <!-- 页脚 -->
        <footer class="border-t-2 border-[#222018] mx-4 mb-4 mt-auto">
            <div
        ...
        <!-- <div id="content" class="min-h-[100dvh] flex flex-col">
...
import { onMounted, onBeforeMount, ref, Teleport } from 'vue';

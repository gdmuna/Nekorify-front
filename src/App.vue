<template>
  <div class="min-w-screen min-h-screen flex items-center flex-col">
    ...
    <header
      ...
      <div class="flex items-center">
        ...
        <nav class="flex items-center">
          <Button variant="link" @click="routerGoTo('/home')" class="text-xl font-[500] m-0 select-none cursor-pointer">
            <Home />
            首页
          </Button>
      ...
      <div class="flex items-center">
        <div class="flex items-center space-x-4">
          <toggleThemeButton :model-value="isDark" @update:model-value="toggleTheme">
            <template #thumb>
        ...
        <div class="h-14 w-[1px] mx-2 bg-neutral-800 dark:bg-neutral-400 select-none"></div>
        <Button class="bg-violet-700 hover:bg-violet-800 dark:bg-violet-600 dark:hover:bg-violet-700 cursor-pointer">
          <Smile />
          加入我们
        </Button>
        <div class="h-10 w-[1px] mx-2 bg-neutral-200 dark:bg-neutral-700 select-none"></div>
    ...
    <Toaster />
    <!-- 主内容区 -->
    <main class="flex-1 w-full items-center justify-center bg-white dark:bg-[#111111]">
      <router-view />
    </main>
  </div>
</template>

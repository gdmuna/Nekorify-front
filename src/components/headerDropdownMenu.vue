...
<template>
    <div ref="root" class="relative">
        <Button
            class="dark:bg-[#0E100F] cursor-pointer dark:text-[#FEFCE4] border-2 py-2"
            :data-isOpen="isOpen"
            @click="isOpen = !isOpen">
        ...
        <teleport v-if="hasApp" to="#appContainer">
            <div
                ref="menu"
                class="fixed flex flex-col py-2 space-y-2 items-end z-40 dark:bg-[#0E100F] border-2 border-t-0 rounded rounded-t-[0]"
                @click="isOpen = !isOpen">

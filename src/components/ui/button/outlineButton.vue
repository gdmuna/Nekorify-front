<template>
    <div
        ref="root"
        :class="cn(props.class, 'w-fit flex flex-col cursor-pointer md:text-2xl')"
        ...
        <div>
            <div ref="container" class="flex items-center space-x-1 relative overflow-hidden">
                ...
                <div ref="icon1Ref">
                    <component
                        :is="icon1 ?? icon"
                        :class="cn(props.icon1Class ?? props.iconClass, 'md:size-6 size-4 m-0')" />
                </div>
                <div ref="icon2Ref" class="absolute left-0">
                    <component
                        :is="icon2 ?? icon"
                        :class="cn(props.icon2Class ?? props.iconClass, 'md:size-6 size-4 m-0')" />
                </div>
            </div>
            <div
                ref="bottomLine"
                :class="cn(props.bottomLineClass, 'w-full h-[1px] mt-1')"

...
<template>
    <SwitchRoot
        ...
        <SwitchThumb
            ...
            :class="
                cn(
                    'bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-5 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[1.2rem] data-[state=unchecked]:translate-x-0'
                )
            ">
            <slot name="thumb" />
        </SwitchThumb>

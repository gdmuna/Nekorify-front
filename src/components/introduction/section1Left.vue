<template>
    <div
        ref="root"
        class="relative xl:*:text-7xl lg:*:text-[4rem] md:*:text-[3.5rem] *:text-[2.5rem] md:my-0 my-2 font-bold *:leading-[1.2em] tracking-[0.2em] !pointer-events-none will-change-transform *:whitespace-nowrap">
        ...
        <div
            class="absolute top-0 left-0 translate-x-[1%] translate-y-[1%] flex flex-col font-bold text-[#0E100F] z-20 *:overflow-hidden">
            <div class="flex flex-row md:flex-col self-start">
        ...
        <div
            class="absolute top-0 left-0 translate-x-[1.5%] translate-y-[1.5%] flex flex-col font-bold z-10 *:overflow-hidden">
            <div class="flex flex-row md:flex-col self-start">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-1/2 z-0 *:overflow-hidden">
            <div
                class="relative xl:*:text-8xl lg:*:text-[5.5rem] md:*:text-[4.25rem] *:text-[3.75rem] *:leading-[1.2em] font-bold tracking-[0.2em] whitespace-nowrap">
...
function divideGroup(groups: Array<Array<any>>) {
    ...
    groups.forEach((group) => {
        ...
        const mainSplit = new SplitText(main, {
            type: 'chars,lines',
            mask: 'chars',
            linesClass: 'line',
            charsClass: 'char'
        });
        const shadowSplit1 = new SplitText(shadow1, {
            type: 'chars,lines',
            mask: 'chars',
            linesClass: 'line',
            charsClass: 'char'
        });
        const shadowSplit2 = new SplitText(shadow2, {
            type: 'chars,lines',
            mask: 'chars',
            linesClass: 'line',
            charsClass: 'char'
        ...
        charsGroups.push(
            mainSplit.chars.map((char, index) => [char, shadowSplit1.chars[index], shadowSplit2.chars[index]])
        );
    });

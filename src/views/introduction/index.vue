<template>
    <div ref="introPageRoot" class="dark:bg-[#0E100F] w-[100dvw] mb-10">
        ...
        <section ref="section1" class="relative h-[100dvh] flex items-center justify-center pt-14 bg-gray-100">
            ...
            <!-- section 主内容 -->
            <div
                class="z-10 w-full flex flex-col md:flex-row items-center justify-evenly pointer-events-none *:pointer-events-auto">
                <!-- 左侧内容 -->
            ...
            <div
                class="absolute bottom-0 left-1/2 flex items-center justify-between -translate-x-1/2 mb-2 space-x-2 z-10 pointer-events-none">
                ...
                <div class="flex flex-col xl:mt-40 mt-16 ml-8 mr-2 xl:mx-6">
                    ...
                    <div class="relative xl:mt-100 mt-6">
                        <macWindow border enterAnimate :enableSplitText="!isMobile" class="xl:!w-128 xl:ml-20">
                            <template #TR>
                                <div class="flex-1"></div>
                                <img src="/src/assets/ACM-LOGO/acm-logo.svg" alt="" class="size-8" />
                    ...
                    <div class="flex items-center justify-evenly xl:mt-48 mt-6">
                        ...
                        <macWindow border enterAnimate :enableSplitText="!isMobile" class="xl:!w-128">
                            <template #TR>
                                ...
                                <img src="/src/assets/ACM-LOGO/acm-logo.svg" alt="" class="size-7" />
                            </template>
                            <template #main>
                    ...
                    <div ref="section3_scrollContainer" class="w-full h-full flex xl:flex-row flex-col items-center">
                        ...
                        <div
                            ...
                            <h1 class="will-change-transform">
                                ...
                                <span
                                    class="section-3-title-1-block title-block rounded-lg text-[#0E100F] inline-block md:px-8 md:py-2 px-4 py-1">
                                    FACTORY
                                </span>
                            </h1>
                            <h1 class="xl:ml-24 will-change-transform">
                                ...
                                <span
                                    class="section-3-title-2-block title-block rounded-lg text-[#0E100F] inline-block md:px-8 md:py-2 px-4 py-1">
                                    FOUNDRY
                                </span>
                            </h1>
                        </div>
                        ...
                        <div
                            ...
                            <macWindow border>
                                ...
                                <template #main>
                                    <div class="flex flex-col items-center justify-between h-full w-full">
                                        ...
                                        <p
                                            class="flex-1 flex items-center justify-center p-4 md:text-lg font-bold tracking-wider whitespace-pre-wrap">
                                            渐进式前端框架，轻量易上手。采用组件化设计，支持双向数据绑定，简化单页面应用（SPA）开发，生态丰富（Vuex/Vue
                                            Router）。
                                        </p>
                                    </div>
                                </template>
                            ...
                            <macWindow border>
                                ...
                                <template #main>
                                    <div class="flex flex-col items-center justify-between h-full w-full">
                                        ...
                                        <p
                                            class="flex-1 flex items-center justify-center p-4 md:text-lg font-bold tracking-wider whitespace-pre-wrap">
                                            Node.js的Web框架，提供路由、中间件等工具。以简约灵活著称，可快速构建RESTful
                                            API及服务器端应用。
                                        </p>
                                    </div>
                                </template>
                            ...
                            <macWindow border>
                                <template #TR>
                                    <div class="flex-1"></div>
                                    <img src="/src/assets/ACM-LOGO/acm-logo.svg" alt="" class="md:size-8 size-5" />
                                    <span class="text-lg Association-ACM">GDMU-ACM</span>
                                </template>
                                <template #main>
                                    <div class="flex flex-col items-center justify-between h-full w-full">
                            ...
                            <macWindow border>
                                ...
                                <template #main>
                                    <div class="flex flex-col items-center justify-between h-full w-full">
                                        ...
                                        <p
                                            class="flex-1 flex items-center justify-center p-4 md:text-lg font-bold tracking-wider whitespace-pre-wrap">
                                            实时目标检测算法（You Only Look
                                            Once）。单次前向传播预测多目标位置与类别，速度极快，适用自动驾驶、安防监控等场景。
                                        </p>
                                    </div>
                                </template>
                            </macWindow>
                ...
                <div
                    ...
                    <div>
                        ...
                        <h1>
                            ...
                            <span
                                class="section-3-title-3-block title-block text-[#0E100F] inline-block md:px-8 md:py-2 px-4 py-1 rounded-lg">
                                FORGE
                            </span>
                        </h1>
                    </div>
        ...
        <section class="bg-gray-100 dark:bg-[#0E100F]">
            <div class="xl:pt-24 md:pt-16 pt-8">
                ...
                <!-- 贡献者名单 -->
                <div
                    class="w-full grid md:grid-cols-2 grid-cols-1 xl:gap-20 gap-10 justify-items-center md:mt-24 mt-8 xl:pl-14 xl:pr-16 md:pl-4 md:pr-8 pl-2 pr-8">
                        ...
                        <template #main>
                            <div class="flex-1 flex items-center">
                                ...
                                <div class="flex-1 h-full flex flex-col justify-center ml-4 min-w-1/3">
                                    ...
                                    <p class="md:text-lg text-sm"># 谷子 # 周边 # 爱门 # 大胃袋</p>
                                    <p class="md:text-lg text-sm">游云拂风，花染湛空 ~ ♪ ♥</p>
                                </div>
                            </div>
                        </template>
                    </macWindow>
        ...
        <section class="bg-gray-200 dark:bg-[#0E100F]">
            <div class="xl:pt-36 md:pt-24 pt-16">
                ...
                <div
                    class="md:space-y-8 space-y-4 md:mt-10 mt-5 md:mx-6 mx-4 text-center md:text-3xl text-lg font-bold text-emerald-400">
                    <p>感谢 网协传奇老祖 提供的服务器与域名支持✨</p>
                    <p>感谢 网协“画之执政”蛋总 提供的吉祥物素材✨</p>
                    <p>感谢 黎大会长 提供的协调保障服务✨</p>
                    <p>感谢 火火大王 提供的新版ACM LOGO✨</p>
...
// 导入图标
import { BrainCircuit, Puzzle, Satellite, ChevronsUp, ChevronsDown, ExternalLink } from 'lucide-vue-next';

// 导入 Lottie 动画库
import lottie from 'lottie-web';

// 导入动画数据
import Webdesign from '@/assets/animations/Webdesign.json';
import programmingLottie from '@/assets/animations/programming.json';
...
const section2_dynamicTitleArray = [section2_dynamicTitle_1, section2_dynamicTitle_2, section2_dynamicTitle_3];
...
onMounted(() => {
    ...
    animationSys.smootherEffects([lottieContainerA, lottieContainerB, cat_smile, fish_smile], { speed: 1.2 });
    // 初始化 GSAP 动画
    initAnimate();
    if (isMobile.value) {
...
function section2_dynamicTitleAnimation(index: number) {
    ...
    tl.to(el, {
        ...
        delay: 2,
        onComplete: () => {
            section2_dynamicTitleIndex.value =
                (section2_dynamicTitleIndex.value + 1) % section2_dynamicTitleArray.length;
